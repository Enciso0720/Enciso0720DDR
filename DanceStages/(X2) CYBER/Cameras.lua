...
t.Camera1MessageCommand=function(self)
	ResetCamera()
	Camera:addz(-10):addx(15):addy(-10):addrotationx(20):addrotationy(-20):smooth(5.7):addx(-10):addrotationx(-60):addz(10):addy(50):addrotationy(40)
end
...
t.Camera5MessageCommand=function(self)
	ResetCamera()
	Camera:addrotationx(-60):addy(50):smooth(5.7):addrotationy(10):addrotationx(5)
end
...
t.Camera7MessageCommand=function(self)
	ResetCamera()
	Camera:addrotationx(90):addy(60):addx(60):addz(-40):smooth(5.7):addrotationy(10)
end
...
t.Camera9MessageCommand=function(self)
	ResetCamera()
	Camera:addz(-90):addx(20):addy(0):addrotationy(40):smooth(5.7):addrotationy(20)
end
