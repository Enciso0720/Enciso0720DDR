		...
		t[#t + 1] =
			...
			Def.Model {
				...
				OnCommand = function(self)
					self:cullmode(_CM):zoom(CheckStageConfigurationNumber(1, "StageZoom"))
					self:xy(
						CheckStageConfigurationNumber(0, "StageXOffset"),
						CheckStageConfigurationNumber(0, "StageYOffset")
					)
					self:addx(X or 0):addy(Y or 0):addz(Z or 0):addrotationx(rX or 0):addrotationy(rY or 0):addrotationz(
						rZ or 0
					):zoom((CheckStageConfigurationNumber(1, "StageZoom")) + (Zo or 0)):position(ModelTime or 0)
