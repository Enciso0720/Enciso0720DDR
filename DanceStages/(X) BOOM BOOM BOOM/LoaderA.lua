...
local t = Def.ActorFrame{}
	...
	function DSMap(MapCode, _CM, X, Y, Z, rX, rY, rZ, Zo, ModelTime, DA)
		t[#t + 1] =
			Def.ActorFrame {
			...
			Def.Model {
				...
				OnCommand = function(self)
					...
					self:addx(X or 0):addy(Y or 0):addz(Z or 0):addrotationx(rX or 0):addrotationy(rY or 0):addrotationz(rZ or 0)
						:zoom(2.1 + (Zo or 0)):position(ModelTime or 0):diffusealpha(DA or 1)
	...
	-- BACKGROUND SCROLLER
	DSMap("Map_A2",2)
	DSMap("Map_A2",2,0,0,0,0,0,0,0,0,0.5)
