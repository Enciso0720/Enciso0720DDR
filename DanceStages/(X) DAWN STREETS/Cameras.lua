...
t.Camera2MessageCommand=function(self)
	ResetCamera()
	Camera:addrotationx(-30):addy(20):addz(20):smooth(5.7):addrotationx(30):addy(-15):addz(-20)
end
t.Camera3MessageCommand=function(self)
	ResetCamera()
	Camera:addrotationy(105):addrotationx(-20):addy(-25):addz(90):addx(-10):smooth(5.7):addx(-30)
end
...
t.Camera7MessageCommand=function(self)
	ResetCamera()
	Camera:addy(10):addz(-5):addx(12):addrotationx(-15):smooth(5.7):addx(-24)
end
...
t.Camera11MessageCommand=function(self)
	ResetCamera()
	Camera:addz(-40):addx(10):addy(20):addrotationy(-20):addrotationx(-10):smooth(5.7):addx(-10)
end
